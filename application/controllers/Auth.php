...
class Auth extends CI_Controller
{
    ...
    {
        $data['devisi'] = $this->db->get('devisi')->result_array();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'role_id' => 2, // 2 untuk member
                'is_active' => 0, // karna biar posisi aktif 0 untuk non aktif
                'date_created' => time()
            ];
    ...
    public function blocked()
    {
        ...
        $pinjam = $this->M_home->hitung_peminjaman();
        $cuti = $this->M_home->hitung_cuti();
        $izin = $this->M_home->hitung_izin();
        $spl = $this->M_home->hitung_spl();
        $kasbon = $this->M_home->hitung_kasbon();
        $data['title'] = "vbloked";
