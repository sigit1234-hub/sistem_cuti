                                    ...
                                    <?php foreach ($cuti as $d) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href=" <?= base_url('Hrd/delete_cuti/') . $d['id']; ?>" class="btn btn-default" onclick="return confirm('yakin?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="user" method="POST" action="<?= base_url('Hrd/edit_acc'); ?>">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $d['id']; ?>">
                                    <input type="hidden" class="form-control" id="durasi" name="durasi" value="<?= $d['durasi']; ?>">
                                    <input type="hidden" class="form-control" id="nama_id" name="nama_id" value="<?= $d['nama_id']; ?>">
                                    <input type="hidden" class="form-control" id="kuota" name="kuota" value="<?= $d['kuota_cuti']; ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" id="status" name="status">
                                        <option value=""><?php if ($d['status'] == 1) {
                                                                echo "Meunggu Persetujuan";
                                                            } elseif ($d['status'] == 2) {
                                                                echo "Disetujui";
                                                            } elseif ($d['status'] == 3) {
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mengetahui" name="mengetahui" value="<?= $d['mengetahui']; ?>" readonly>
                                    <?= form_error('mengetahui', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> Atas Persetujuan</label>
                                    <select type="text" class="form-control" id="persetujuan" name="persetujuan">
                                        <option>Ibu Bernadetta Anna P</option>
                                    </select>
