                ...
                <?php foreach ($sql as $nm) : ?>
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-4">
                            ...
                            <input type="date" class="form-control" id="tanggal_acc_head" name="tanggal_acc_hr" value="<?= $d['tanggal'] ?>">
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-4">
                            <label for="exampleInputEmail1">Sampai tanggal</label>
                            <input type="date" class="form-control" id="date_acc_head" name="date_acc_hr" value="<?= $d['date_end'] ?>">
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-4">
                            <div class="form-group" disabled>
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                            <div class="form-group" disabled>
                                ...
                                <textarea type="text" class="form-control" id="catatan" name="catatan" placeholder="Tinggalkan Catatan...."></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
