                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Data Cuti/ACC</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
...
foreach ($cuti as $d) : $no++ ?>
    ...
    <div id="custom-modal<?= $d['id'] ?>" class="modal-demo" style="width: 70%;">
        ...
        <form class="user" method="post" action="<?= base_url('Hrd/edit_cuti'); ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                            <div class="form-group" disabled>
                                ...
                                <input type="hidden" class="form-control" id="hr" name="hr" value="<?= $user['id']; ?>">
                                ...
                                <input type="hidden" class="form-control" id="value" name="value" value="2">
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="date" class="form-control" id="tanggal_acc_hr" name="tanggal_acc_hr" value="<?= $d['tanggal_acc_head'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <input type="date" class="form-control" id="sampai_tanggal" name="sampai_tanggal" value="<?= $d['date_acc_head'] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                            <div class="form-group" disabled>
                                ...
                                <textarea type="text" class="form-control" id="catatan" name="catatan" placeholder="Catatan HRD"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                        </div>
